...
const TransferModal = props => {
  const { kitty, setStatus, kittyId } = props
      ...
      <Modal.Actions>
        ...
        <TxButton
          ...
          attrs={{
            ...
            callable: 'transfer',
            inputParams: [formValue.target, kittyId],
      ...
      <Modal.Actions>
        ...
        <TxButton
          ...
          attrs={{
            palletRpc: 'substrateKitties',
            callable: 'setPrice',
            inputParams: [kittyId, formValue.target],
            paramFields: [true, true],
          }}
        />
      </Modal.Actions>
      ...
      <Modal.Actions>
        ...
        <TxButton
          ...
          attrs={{
            palletRpc: 'substrateKitties',
            callable: 'buyKitty',
            inputParams: [kittyId, kitty.price],
            paramFields: [true, true],
          }}
        />
      </Modal.Actions>
    ...
    <Card>
      ...
      <Card.Content extra style={{ textAlign: 'center' }}>
        {owner === currentAccount.address ? (
          <>
            <SetPrice kitty={kitty} kittyId={kittyId} setStatus={setStatus} />
            <TransferModal
              kitty={kitty}
              kittyId={kittyId}
              setStatus={setStatus}
          ...
          <>
            <BuyKitty kitty={kitty} kittyId={kittyId} setStatus={setStatus} />
          </>
        )}
      </Card.Content>
    </Card>
...
const KittyCards = props => {
  const { kitties, setStatus, kittyIds } = props
